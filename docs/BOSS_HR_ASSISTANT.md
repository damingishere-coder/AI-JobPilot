...
5. 在投递牛马工作台的“环境配置”页面找到“BOSS HR 值守与 QQ 通知”，选择当前人物档案和“私人 QQ”或“指定群聊”，填写真实资料。Token、目标 QQ/群号和操作人 QQ 不会在读取接口中明文返回。

## 使用方法

- 点击 BOSS 页面右下角助手浮窗里的“开始值守”时，当前 Chrome 标签页必须是 BOSS 求职者聊天页；OpenCLI 会绑定这个现有标签页，不会新开自动化浏览器。浮窗只保留状态、值守控制和待确认回复，设置统一由工作台管理。
